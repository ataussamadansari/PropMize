...
class BuyerMainEndDrawer extends GetView<BuyerMainController>
{
    const BuyerMainEndDrawer({super.key});
    ...
    Widget build(BuildContext context)
    {
        return Drawer(
            ...
            child: SafeArea(
                child: Obx(()
                    {
                        final chatHistory = controller.assistantChatController.chatHistoryList.value;
                        final chats = chatHistory?.data?.chats ?? [];
                        final activeChatId = controller.assistantChatController.aiChat.value?.data?.id;
                        ...
                        return Column(
                            children: [
                                ...
                                ListTile(
                                    ...
                                    onTap: ()
                                    {
                                        controller.assistantChatController.startNewChat();
                                ...
                                isLoggedIn ?
                                    Expanded(
                                        child: controller.assistantChatController.isLoadingHistory.value ? ShimmerHistoryLoader() : chats.isEmpty
                                            ? const Center(
                                                child: Text(
                                            ...
                                            : RefreshIndicator(
                                                onRefresh: controller.assistantChatController.refreshChatHistory,
                                                child: NotificationListener<ScrollNotification>(
                                                    onNotification: (scrollInfo)
                                                    {
                                                        ...
                                                        if (scrollInfo.metrics.pixels ==
                                                            ...
                                                            controller.assistantChatController.hasMoreHistory.value &&
                                                            !controller.assistantChatController.isLoadingHistory.value)
                                                        {
                                                            controller.assistantChatController.loadMoreChatHistory();
                                                        }
                                                        return false;
                                                    },
                                                    child: ListView.builder(
                                                        ...
                                                        itemCount: chats.length +
                                                            (controller.assistantChatController.isLoadingHistory.value ? 1 : 0),
                                                        itemBuilder: (context, index)
                                                        {
                                                            ...
                                                            return InkWell(
                                                                onTap: ()
                                                                {
                                                                    ...
                                                                    controller.assistantChatController.loadChatById(chat.id ?? "", byHistory: true);
                                                                    Navigator.of(context).pop();
                                                                },
                                                                child: Container(
                    ...
                    actions: [
                        ...
                        CupertinoDialogAction(
                            ...
                            async
                            {
                                ...
                                // {
                                Navigator.pop(context, controller.assistantChatController.deleteChatById(chatId));
                                // }
                            }
                        )
                    ]
