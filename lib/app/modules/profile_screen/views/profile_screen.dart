                ...
                children: [
                            ...
                            children: [
                                ...
                                Row(
                                    ...
                                    children: [
                                        ...
                                        SizedBox(width: 4),
                                        Text(
                                            controller.authController.profile.value?.data?.address!.city ?? "Not Provided",
                                ...
                                // 🔹 Info Cards
                                _infoTile(context, Icons.email, "Email", controller.authController.profile.value!.data!.email ?? "Not Provided"),
                                _infoTile(context, Icons.phone, "Phone", controller.authController.profile.value!.data!.phone ?? "Not provided"),
                                _infoTile(context, Icons.person, "Member since", DateTimeHelper.formatMonthYear(controller.authController.profile.value!.data!.createdAt ?? "")),
                    ...
                    Container(
                        ...
                        child: Column(
                            ...
                            children: [
                                Text('Personal Information', style: context.textTheme.headlineSmall),
                                Text('Update your personal details and contact information', style: context.textTheme.bodySmall),
                                ...
                                CustomTextFormFields(
                                    ...
                                    maxLine: controller.isEnable.value ? 5 : controller.bioController.text.isEmpty ? 1 : 3,
                                    singleLine: false,
