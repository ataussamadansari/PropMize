        ...
        return Obx(()
            {
                ...
                if (controller.isLoading.value || controller.authController.profile.value == null)
                {
                ...
                return Scaffold(
                    appBar: AppBar(
                        ...
                        title: Column(
                            ...
                            children: [
                                Text('My Profile'),
                                Text('Manage your account and preferences', style: context.textTheme.labelSmall?.copyWith(color: Colors.grey))
                            ]
                        )
                    ),
                    body: Stack(
