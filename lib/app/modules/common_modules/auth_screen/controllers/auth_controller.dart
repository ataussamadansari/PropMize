...
class AuthController extends GetxController
{
    ...
    void _navigateAfterLogin(dynamic userData) {
    ...
    Future<void> verifyOtp() async
    {
        try
        {
            ...
            if (response.success)
            {
                ...
                if (user.value != null)
                {
                    StorageServices.to.write("role", user.value!.data.user.role);
    ...
    void logout()
    {
        ...
        StorageServices.to.remove('name');
    ...
    Future<ApiResponse<UserMe>> updateProfile(dynamic updateData, {File? image}) async
    {
        try
        {
            ...
            if (response.success)
            {
                ...
                StorageServices.to.write("phone", response.data!.data!.phone);
            }
