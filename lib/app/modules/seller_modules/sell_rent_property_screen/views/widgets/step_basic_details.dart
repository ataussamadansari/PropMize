            ...
            child: SingleChildScrollView(
                ...
                child: Column(
                    ...
                    children: [
                        ...
                        Row(
                            children: [
                                Expanded(child: CustomTextField(controller: controller.bedroomsController, labelText: "Bedrooms", hintText: "e.g. 3", isNumeric: true)),
                                const SizedBox(width: 16),
                                Expanded(child: CustomTextField(controller: controller.bathroomsController, labelText: "Bathrooms", hintText: "e.g. 2", isNumeric: true))
                            ]
                        ),
                        const SizedBox(height: 16),
                        Row(
                            children: [
                                Expanded(child: CustomTextField(controller: controller.balconiesController, labelText: "Balconies", hintText: "e.g. 1", isNumeric: true)),
                                const SizedBox(width: 16),
                                Expanded(child: CustomTextField(controller: controller.parkingController, labelText: "Parking", hintText: "e.g. 1", isNumeric: true))
                            ]
                        ),
                        const SizedBox(height: 16),
                        Row(
