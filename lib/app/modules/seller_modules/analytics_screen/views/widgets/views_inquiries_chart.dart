...
class ViewsInquiriesChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Determine the maximum Y-axis value for the chart with proper rounding
    final maxValue = periodData.map((d) => d.views ?? 0).reduce((a, b) => a > b ? a : b);
    final maxY = _getNiceMaxValue(maxValue.toDouble());
  ...
  // Replace the _getNiceMaxValue function with this simpler version:
...
// And replace _getLeftTitleInterval with:
