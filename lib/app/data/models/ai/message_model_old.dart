...
class ChatMessage {
  ...
  factory ChatMessage.fromJson(Map<String, dynamic> json) {
    return ChatMessage(
      ...
      timestamp: json['timestamp'],
      properties: json['properties'] != null
          ? List<dynamic>.from(json['properties'])
          : null,
      suggestions: json['suggestions'] != null
          ? List<dynamic>.from(json['suggestions'])
          : null,
      id: json['_id'],
    );
  }
...
class Property {
  ...
  factory Property.fromDynamic(dynamic json) {
    if (json is Map<String, dynamic>) {
      return Property.fromJson(json);
    } else if (json is String) {
      // fallback agar sirf ek string aayi
      return Property(
        id: json,
        title: json, // ya tum apne UI me kaise dikhana chahte ho
      );
    } else {
      return Property();
    }
