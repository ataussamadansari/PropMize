...
class OlaBackground extends StatelessWidget {
  ...
  List<Widget> _buildWaves() {
    return [
      ...
      _buildAnimatedWave(
        size: 150,
        color: primaryColor.withValues(alpha: waveOpacity - 0.02),
        top: 100,
        right: -20,
        duration: 12000,
      ),
      _buildAnimatedWave(
        size: 180,
        color: primaryColor.withValues(alpha: waveOpacity - 0.01),
        bottom: 200,
        left: -40,
        duration: 18000,
      ),
      _buildAnimatedWave(
        size: 120,
        color: primaryColor.withValues(alpha: waveOpacity - 0.03),
        bottom: 50,
        right: -30,
        duration: 14000,
      ),
  ...
  List<Widget> _buildDots() {
    return [
      ...
      _buildFloatingDot(
        size: 6,
        color: primaryColor.withValues(alpha: dotOpacity - 0.02),
        top: 300,
        right: 80,
        duration: 6000,
      ),
